...
class EventListUseCases:
    def __init__(self, event_list_repo: IEventListRepo, event_list_services: EventListService):
    ...
    def update_event_list(self, id: str, content: EventListUpdate, current_user: UserOut) -> EventList:
        if not current_user.approved:
            raise UnauthorizedException("You cannot perform this action.")
